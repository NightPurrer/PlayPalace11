...
sorry-play-start = { $player } moves pawn { $pawn } out of start.
sorry-play-forward = { $player } moves pawn { $pawn } forward { $steps }.
sorry-play-backward = { $player } moves pawn { $pawn } backward { $steps }.
sorry-play-swap = { $player } swaps pawn { $pawn } with { $target_player } pawn { $target_pawn }.
sorry-play-sorry = Sorry! { $player } replaces { $target_player } pawn { $target_pawn } with pawn { $pawn }.
sorry-play-split7 = { $player } splits 7: pawn { $pawn_a } moves { $steps_a }, pawn { $pawn_b } moves { $steps_b }.
